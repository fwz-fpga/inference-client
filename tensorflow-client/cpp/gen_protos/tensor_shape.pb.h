...
#ifndef PROTOBUF_tensor_5fshape_2eproto_INCLUDED
#define PROTOBUF_tensor_5fshape_2eproto_INCLUDED
...
namespace google {
namespace protobuf {
template<> ::tensorflow::TensorShapeProto* Arena::CreateMessage< ::tensorflow::TensorShapeProto>(Arena*);
template<> ::tensorflow::TensorShapeProto_Dim* Arena::CreateMessage< ::tensorflow::TensorShapeProto_Dim>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace tensorflow {
...
class TensorShapeProto_Dim : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.TensorShapeProto.Dim) */ {
 public:
  ...
  inline TensorShapeProto_Dim* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::CreateMessage<TensorShapeProto_Dim>(NULL);
  }
...
class TensorShapeProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.TensorShapeProto) */ {
 public:
  ...
  inline TensorShapeProto* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::CreateMessage<TensorShapeProto>(NULL);
  }
...
#endif  // PROTOBUF_tensor_5fshape_2eproto_INCLUDED
