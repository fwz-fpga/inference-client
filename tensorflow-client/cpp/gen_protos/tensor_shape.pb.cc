...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::TensorShapeProto_Dim* Arena::CreateMessage< ::tensorflow::TensorShapeProto_Dim >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tensorflow::TensorShapeProto_Dim >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::TensorShapeProto* Arena::CreateMessage< ::tensorflow::TensorShapeProto >(Arena* arena) {
