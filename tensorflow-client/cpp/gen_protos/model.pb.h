...
#ifndef PROTOBUF_model_2eproto_INCLUDED
#define PROTOBUF_model_2eproto_INCLUDED
...
void AddDescriptors();
void InitDefaultsModelSpecImpl();
void InitDefaultsModelSpec();
inline void InitDefaults() {
  InitDefaultsModelSpec();
}
}  // namespace protobuf_model_2eproto
...
namespace google {
namespace protobuf {
template<> ::tensorflow::serving::ModelSpec* Arena::CreateMessage< ::tensorflow::serving::ModelSpec>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace tensorflow {
namespace serving {
...
class ModelSpec : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.serving.ModelSpec) */ {
 public:
  ...
  inline ModelSpec* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::CreateMessage<ModelSpec>(NULL);
  }
 ...
 private:
  ...
  friend void ::protobuf_model_2eproto::InitDefaultsModelSpecImpl();
};
// ===================================================================
...
inline ::google::protobuf::Int64Value* ModelSpec::mutable_version() {
  if (!has_version()) {
    clear_version_choice();
    set_has_version();
    version_choice_.version_ = ::google::protobuf::Arena::CreateMessage< ::google::protobuf::Int64Value >(
        GetArenaNoVirtual());
  }
...
#endif  // PROTOBUF_model_2eproto_INCLUDED
