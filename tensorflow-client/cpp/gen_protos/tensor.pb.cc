...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
      ...
      "ors\030\003 \003(\0132\027.tensorflow.TensorProtoB-\n\030or"
      "g.tensorflow.frameworkB\014TensorProtosP\001\370\001"
      "\001b\006proto3"
  };
  ...
  if (this->has_tensor_shape()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        2, *tensor_shape_, deterministic, target);
  }
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::TensorProto* Arena::CreateMessage< ::tensorflow::TensorProto >(Arena* arena) {
  return Arena::CreateMessageInternal< ::tensorflow::TensorProto >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::VariantTensorDataProto* Arena::CreateMessage< ::tensorflow::VariantTensorDataProto >(Arena* arena) {
