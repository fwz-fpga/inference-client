...
void InitDefaultsModelSpec() {
  ...
  ::google::protobuf::GoogleOnceInit(&once, &InitDefaultsModelSpecImpl);
}
  ...
  if (has_version()) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageToArray(
        2, *version_choice_.version_, deterministic, target);
  }
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::tensorflow::serving::ModelSpec* Arena::CreateMessage< ::tensorflow::serving::ModelSpec >(Arena* arena) {
