...
#ifndef PROTOBUF_resource_5fhandle_2eproto_INCLUDED
#define PROTOBUF_resource_5fhandle_2eproto_INCLUDED
...
namespace google {
namespace protobuf {
template<> ::tensorflow::ResourceHandleProto* Arena::CreateMessage< ::tensorflow::ResourceHandleProto>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace tensorflow {
...
class ResourceHandleProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.ResourceHandleProto) */ {
 public:
  ...
  inline ResourceHandleProto* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::CreateMessage<ResourceHandleProto>(NULL);
  }
...
#endif  // PROTOBUF_resource_5fhandle_2eproto_INCLUDED
