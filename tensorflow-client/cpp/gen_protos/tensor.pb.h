...
#ifndef PROTOBUF_tensor_2eproto_INCLUDED
#define PROTOBUF_tensor_2eproto_INCLUDED
...
namespace google {
namespace protobuf {
template<> ::tensorflow::TensorProto* Arena::CreateMessage< ::tensorflow::TensorProto>(Arena*);
template<> ::tensorflow::VariantTensorDataProto* Arena::CreateMessage< ::tensorflow::VariantTensorDataProto>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace tensorflow {
...
class TensorProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.TensorProto) */ {
 public:
  ...
  inline TensorProto* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::CreateMessage<TensorProto>(NULL);
  }
...
class VariantTensorDataProto : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tensorflow.VariantTensorDataProto) */ {
 public:
  ...
  inline VariantTensorDataProto* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::CreateMessage<VariantTensorDataProto>(NULL);
  }
...
#endif  // PROTOBUF_tensor_2eproto_INCLUDED
